...
craw chlorophyll observations.  As such, the values plotted are meaningless to 
potential readers.  We need to provide a  axis that indicates the non-linearity
of the Y axis.
